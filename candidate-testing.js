...
let question = "Who was the fist American woman in space? ";
//should correct answer require capital S R?
let correctAnswer = "Sally Ride";
let candidateAnswer = ""; 
let questions = ["1) Who was the fist American woman in space? ", "2) True or false: 5000 meters === 5 kilometer. ", "3) (5+3)/2 * 10 = ? ", "4) Given the array [8, 'Orbit', 'Trajectory', 45], what entry is at index 2? ", "5) What is the minimum crew size for the ISS? "];
